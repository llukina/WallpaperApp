...
import com.example.android.wallpaperapp.Adapters.CollectionsAdapter;
...
public class CollectionsFragment extends Fragment {
    ...
    @BindView(R.id.gridview_collections_fragment)
    GridView gridView;
    @BindView(R.id.progressbar_collections_fragment)
    ...
    @OnItemClick(R.id.gridview_collections_fragment)
